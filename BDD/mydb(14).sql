...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 23, 2016 at 04:52 PM
...
INSERT INTO `classe` (`idClasse`, `Promotion`, `Location`, `hashClasse`) VALUES
(1, 2017, '1', '101'),
(2, 2016, '2', '104');
...
CREATE TABLE IF NOT EXISTS `eleve` (
  ...
  `Nom` varchar(30) NOT NULL COMMENT 'Nom de l''̩l̬ve',
  `Prenom` varchar(30) NOT NULL COMMENT 'Pr̩nom de l''̩l̬ve',
  `idClasse` tinyint(3) unsigned NOT NULL,
  PRIMARY KEY (`idEleve`),
  KEY `idClasse` (`idClasse`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='une ligne pour chaque ̩l̬ve' AUTO_INCREMENT=8 ;
...
(17, 'TP portail', 7, 2, '2016-04-22 17:42:48', '12'),
(18, 'TP verin', 4, 3, '2016-04-22 17:42:52', '17'),
(19, 'TP verin', 5, 3, '2016-04-22 17:42:54', '22'),
(20, 'TP verin', 6, 3, '2016-04-22 17:42:57', '17'),
(21, 'TP verin', 7, 3, '2016-04-22 17:43:06', '19'),
(22, 'TP carrosserie', 4, 4, '2016-04-22 17:43:09', '20'),
(23, 'Tp carrosserie', 5, 4, '2016-04-22 17:43:13', '21'),
(24, 'TP carrosserie', 6, 4, '2016-04-22 17:43:17', '54'),
(25, 'TP carrosserie', 7, 4, '2016-04-22 17:43:20', '48');
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  PRIMARY KEY (`idUser`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='une ligne pour chaque utilisateur (prof)' AUTO_INCREMENT=6 ;
